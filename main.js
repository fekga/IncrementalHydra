...
var _user$project$Main$fighterView = function (fighters) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('It is being attacked by the following brave fighters:'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _rundis$elm_bootstrap$Bootstrap_ListGroup$ul(
					A2(_elm_lang$core$List$map, _user$project$Main$viewFighterGroup, fighters)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$viewProgressBar = F3(
	function (percentage, label, color) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_0: {
													ctor: '_Tuple2',
													_0: 'width',
													_1: A2(_elm_lang$core$Basics_ops['++'], percentage, '%')
												},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'border-width', _1: '0px 1px 0px 0px'},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'border-color', _1: 'black'},
														_1: {
...
var _user$project$Main$viewHydraBody = function (body) {
	return A2(
		_elm_lang$html$Html$p,
		{ctor: '[]'},
		{
...
var _user$project$Main$viewHydra = F2(
	function (hydra, head) {
		...
		if (_p4.ctor === 'Just') {
			...
			return _user$project$Main$viewHydraBody(hydra.body);
		}
	});
var _user$project$Main$hydraView = function (hydra) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Hydra'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$Main$viewHydra,
					hydra,
					_elm_lang$core$List$head(hydra.heads)),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$Health = F3(
	function (a, b, c) {
...
var _user$project$Main$FighterGroup = F3(
	function (a, b, c) {
		return {tier: a, status: b, size: c};
	});
var _user$project$Main$Event = F2(
	function (a, b) {
		return {tier: a, damage: b};
	});
...
var _user$project$Main$singleTargetDamage = F2(
	function (fighter, hydra) {
		...
		return _elm_lang$core$Native_Utils.update(
			hydra,
			{heads: heads, body: body});
	});
var _user$project$Main$takeDamageFrom = F2(
	function (fighters, hydra) {
		return A3(_elm_lang$core$List$foldl, _user$project$Main$singleTargetDamage, hydra, fighters);
	});
var _user$project$Main$Knight = {ctor: 'Knight'};
var _user$project$Main$Archer = {ctor: 'Archer'};
var _user$project$Main$Footman = {ctor: 'Footman'};
var _user$project$Main$Villager = {ctor: 'Villager'};
...
var _user$project$Main$initialModel = {
	hydra: _user$project$Main$generateHydra(1),
...
var _user$project$Main$startAttacking = F2(
	function (diff, fighters) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Main$attemptToAttack(diff),
			fighters);
	});
...
var _user$project$Main$startReloading = function (fighters) {
	return A2(_elm_lang$core$List$map, _user$project$Main$reloadSingleFighter, fighters);
};
var _user$project$Main$processAttacks = F2(
	function (diff, model) {
		var attackModeFighters = A2(_user$project$Main$startAttacking, diff, model.fighters);
		var newHydra = A2(_user$project$Main$takeDamageFrom, attackModeFighters, model.hydra);
		var afterAttackFighters = _user$project$Main$startReloading(attackModeFighters);
		return _elm_lang$core$Native_Utils.update(
			model,
			{hydra: newHydra, fighters: afterAttackFighters});
	});
